...
def validate_passport(passport: dict):
    ...
    rules = []
    try:
        rules.append(lambda passport: 1920 <= int(passport['byr']) <= 2002)
        rules.append(lambda passport: 2010 <= int(passport['iyr']) <= 2020)
        rules.append(lambda passport: 2020 <= int(passport['eyr']) <= 2030)
